                    ...
                    <div class="card-body">
                        ...
                        <div class="container" style="margin-bottom: 50px;">
                            <div class="row space ">
                                ...
                                <div class="col-md-7 ">
                                    <h1 class="prem-title color-3 font">1<span
                                            class="er">er</span>&nbsp;&nbsp;&nbsp;&nbsp; premio</h1>
                                    ...
                                    <h1 class=" color-3 font-prem">ganador y sus invitados <span class="phone">(3
                                            ganadores)</span></h1>
                                </div>
                            </div>
                            <div class="row space">
                                ...
                                <div class="col-md-7">
                                    <h1 class="prem-title color-3 font">2<span
                                            class="er">do</span>&nbsp;&nbsp;&nbsp;&nbsp; premio</h1>
                                    ...
                                    <h1 class=" color-3 font-prem">en $300 <span class="phone">(10 ganadores)</span>
                                    </h1>
                                </div>
                            </div>
                            <div class="row space">
                                ...
                                <div class="col-md-7">
                                    <h1 class="prem-title color-3 font">3<span
                                            class="er">er</span>&nbsp;&nbsp;&nbsp;&nbsp; premio</h1>
                                    <h1 class=" color-3 font-prem">Gift Cards de Econo valorados</h1>
                                    <h1 class=" color-3 font-prem">en $150 <span class="phone">(10 ganadores)</span>
                                    </h1>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-2">
                                <button type="button" class="btn btn-ttc  font" data-toggle="modal"
                                    data-target="#term">👉 Ver reglas aquí 👈</button>
                            </div>
                        </div>
                        <br>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form" method="POST"
                                                action="{{ route('registerReceipt') }}" enctype="multipart/form-data"
                                                onsubmit="return validacion()" autocomplete="off">
                                                {{ csrf_field() }}
                                                <div
                                                    class="form-group row {{ $errors->has('nombres') ? ' is-invalid' : '' }}">
                                                    <div class="col-md-6 acer">
                                                        <input id="name" type="text" class="form-control" name="nombres"
                                                        ...
                                                        @endif
                                                        <label for="name"
                                                            class="col-md-12 col-form-label text-md-left font">{{
                                                            __('NOMBRE') }}</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div
                                                    class="form-group row{{ $errors->has('telefono') ? ' has-error' : '' }}">
                                                    <div class="col-md-12">
                                                        <input id="phone" type="number"
                                                            onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                                            class="form-control" name="telefono"
                                                            value="{{ old('telefono') }}" maxlength="14" min="1"
                                                            required>
                                                        ...
                                                        @endif
                                                        <label for="name"
                                                            class="col-md-12 col-form-label text-md-left font">TELÉFONO</label>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        @endif
                                                        <label for="name"
                                                            class="col-md-12 col-form-label text-md-left font">EMAIL</label>
                                                    </div>
                                                </div>
                                                <div
                                                    class="form-group row{{ $errors->has('nacimiento') ? ' has-error' : '' }}">
                                                    <div class="col-md-4">
                                                        <div class="input-group"> <span
                                                                class="input-group-addon"></span>
                                                            <select id="lunch" class="selectpicker form-control"
                                                                name="dia" data-live-search="true" required>
                                                                <option value="{{ old('dia')== null? '' : old('dia')}}">
                                                                    {{ old('dia')== null? "Día" : old('dia')}}</option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group"> <span
                                                            ...
                                                            <select id="lunch" class="selectpicker form-control"
                                                                ...
                                                                <option value="{{ old('mes')== null? '' : old('mes')}}">
                                                                    {{ old('mes')== null? "Mes" : old('mes')}}</option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group"> <span
                                                            ...
                                                            <select id="lunch" class="selectpicker form-control"
                                                                ...
                                                                <option
                                                                    value="{{ old('anio')== null? '' : old('anio')}}">{{
                                                                    old('anio')== null? "Año" : old('anio')}}</option>
                                                    ...
                                                    @endif
                                                    <label for="name" class="col-md-12 col-form-label text-md-left font"
                                                        style="margin-left: 15px;margin-bottom: 15px;">FECHA DE
                                                        NACIMIENTO</label>
                                                </div>
                                                <div
                                                    class="form-group row{{ $errors->has('supermercado') ? ' has-error' : '' }}">
                                                    <div class="col-md-12">
                                                        <div class="input-group"> <span
                                                                class="input-group-addon"></span>
                                                            <select id="supermercado" type="text" name="supermercado"
                                                                class="form-control" required>
                                                                <option
                                                                    value="{{ old('supermercado')== null? '' : old('supermercado')}}">
                                                                    {{ old('supermercado')== null? "SELECCIONA" :
                                                                    old('supermercado')}}</option>
                                                                @foreach ($supermercados as $s)
                                                                <option value="{{ $s->nombres }}">{{ $s->nombres }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <label for="name"
                                                            class="col-md-12 col-form-label text-md-left font">{{
                                                            __('TIENDA ECONO EN LA QUE COMPRASTE') }}</label>
                                                    </div>
                                                </div>
                                                <div
                                                    class="form-group row{{ $errors->has('recibo') ? ' has-error' : '' }}">
                                                    <div class="col-md-12">
                                                        <input id="recibo" type="text" onkeyup="mayus(this);"
                                                            class="form-control" name="recibo"
                                                            value="{{ old('recibo') }}" maxlength="14" min="1" required>
                                                        ...
                                                        @endif
                                                        <label for="name"
                                                            class="col-md-12 col-form-label text-md-left font">NÚMERO DE
                                                            CONTROL</label>
                                                    </div>
                                                </div>
                                                <div class="form-group row frec">
                                                    <label for="name"
                                                        class="col-md-4 col-form-label text-md-center reci font"><br>FOTO
                                                        DE RECIBO</label>
                                                    <div class="col-md-8">
                                                        <label for="fper_user" class="subir" style="width: 50%;">
                                                            <div id="log"></div>
                                                            <img src="/images/logo_img.png" id="prev_profile_user_i"
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="fper-usu">
                                                            <img src="/images/rec.jpg" id="prev_profile_user"
                                                                width="100%" class="img-fluid img-thumbnail"
                                                                style="display: none;margin-bottom: 15px;" />
                                                        </div>
                                                    </div>
                                                    <input name="fper" id="fper_user" onchange='validationProfileUser()'
